...
$sql = "SELECT * FROM products WHERE categories = '$cat_id'"; //Featured neste caso é um boolean, que vai determinar se o produto entra ou nao na home page
...
?>
    ...
    <!-- left side bar -->
        <div class="col-md-2"> <?php include 'admin/widgets/filters.php';?> </div>
    <!-- main content -->
        <div class="col-md-8">
        <h2 class="text-center"><?php echo $category['parent']. ' '.$category['child'];?></h2> <!-- este echo tem a ver com a funçao getCategory VIDEO 25 -->
